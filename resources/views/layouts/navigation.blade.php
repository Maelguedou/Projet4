<nav x-data="{ open: false }" class="bg-gradient-to-r from-sky-700 via-indigo-600 to-indigo-700 text-white shadow-md">
        ...
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center gap-6">
                ...
                <div class="hidden md:flex md:items-center md:space-x-2">
                    <x-nav-link :href="route('home2')" :active="request()->routeIs('dashboard')" class="px-3 py-2 text-sm text-white/90 hover:text-white">
                        {{ __('Dashboard') }}
                    </x-nav-link>
    ...
    <div x-show="open" x-cloak x-transition class="md:hidden bg-gradient-to-r from-sky-700 to-indigo-600/80">
